...
//            [self.protocols outlineViewManager:<#(OutlineViewManager * _Nullable)#> itemVie_Nullablew:<#(NSTableCellView * _Nullable)#> willLoadData:<#(id<ListSupplierProtocol> _Nonnull)#> forRow:<#(NSInteger)#>];
        }
